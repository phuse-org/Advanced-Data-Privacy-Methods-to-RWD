...
- Write:
    results/<benchmark>/<dataset>/<run_id>/metrics.json
    results/<benchmark>/<dataset>/<run_id>/params.json
"""
...
def main() -> None:
    ...
    out = Path("results") / Path(__file__).parent.name / args.dataset / run_id
